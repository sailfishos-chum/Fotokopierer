...
Latest release version: [harbour-fotokopierer-0.4.9.tar.gz][STABLE]
...
[STABLE]: http://chiselapp.com/user/fifr/repository/fotokopierer/tarball/harbour-fotokopierer-0.4.9.tar.gz?uuid=v0.4.9
