...
Fotokopierer needs the [OpenCV][OpenCV] 3.4.0 and [Podofo][Podofo] 0.9.5 libraries. These
...
- [http://sourceforge.net/projects/podofo/files/podofo/0.9.5/podofo-0.9.5.tar.gz/download](http://sourceforge.net/projects/podofo/files/podofo/0.9.5/podofo-0.9.5.tar.gz/download)
...
Extract both archives to the `3rdparty` subdirectory.
	...
	tar -xzf path/to/podofo-0.9.5.tar.gz
