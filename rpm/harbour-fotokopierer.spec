...
pushd rpmbuilddir-%{_arch} &&  cmake -DCMAKE_BUILD_TYPE=RelWithDebInfo \
                                     -DCMAKE_PREFIX_PATH="%{_builddir}/rpmbuilddir-%{_arch}/3rdparty/opencv" \
                                     -DCMAKE_INCLUDE_PATH="%{_builddir}/rpmbuilddir-%{_arch}/3rdparty/podofo;%{_sourcedir}/../3rdparty/podofo-0.9.7/src" \
                                     -DCMAKE_LIBRARY_PATH="%{_builddir}/rpmbuilddir-%{_arch}/3rdparty/podofo/src/podofo" \
                                     -DCMAKE_INSTALL_PREFIX=/usr %{_sourcedir}/..
popd
